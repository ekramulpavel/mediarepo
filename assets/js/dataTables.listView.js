        ...
        listViewExtend.prototype = {
            ...
            _constructor: function(){
                ...
                if(this.c.layout){
                    ...
                    $('.table-container .row:first-child', elem).append('<div class="col-sm-6"><div id="' + dt.table().context[0].sTableId + '_tools" class="dataTables_tools"></div></div>');
                    $('.table-container .row:last-child', elem).prepend(dataTablesLengthElem);
                }
                ...
                if(this.c.grid){
                    ...
                    var btnGridView = $('<button class="btn btn-default"><i class="fas fa-th-large"></i></button>')
                                            .appendTo($(toolsContainer, elem))
                                            .on('click', function() {
                                              $('.dataTables_tools .btn').removeClass('bg-primary text-light');
                    ...
                    var btnListView = $('<button class="btn btn-default bg-primary text-light"><i class="fas fa-list"></i></button>')
                                            .appendTo($(toolsContainer, elem))
                                            .on('click', function() {
                                              $('.dataTables_tools .btn').removeClass('bg-primary text-light');
                                              $(this).addClass('bg-primary text-light');
